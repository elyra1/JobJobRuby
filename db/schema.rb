...
ActiveRecord::Schema[8.0].define(version: 2024_12_22_203059) do
  create_table "resumes", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "title", limit: 80
    t.text "description", limit: 600
    t.text "skills", limit: 400
    t.text "experience", limit: 500
    t.text "education", limit: 200
  ...
  create_table "vacancies", force: :cascade do |t|
    ...
    t.string "title", limit: 80
    t.text "description", limit: 600
    t.text "skills_required", limit: 400
